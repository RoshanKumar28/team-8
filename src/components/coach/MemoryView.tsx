...
import { downloadDataUrl, getReportFile } from "@/lib/files";
    ...
    <div className="app-bg scroll-thin min-h-0 flex-1 overflow-y-auto">
      ...
      <Section icon={FlaskConical} title="Your reports, in plain words">
        ...
        <a
          href="/report"
          target="_blank"
          className="card-soft mt-3 block w-full rounded-[var(--r-sm)] bg-brand py-2.5 text-center text-[12px] font-bold text-brandink"
        >
          Doctor summary — save as PDF
        </a>
        <p className="mt-1.5 text-center text-[10px] text-faint">
          Everything above on one designed page — hand it over at the start of the visit.
        </p>
      </Section>
